...
must always be at the version start of an expression if there are any
$\forall$ types. Then every time there is an application $e_1 e_2$, 
...
core calculus$_\star$ which is similar to how expressions will
...
calculus to core calculus$_\star$ is defined as:
\begin{align*}
