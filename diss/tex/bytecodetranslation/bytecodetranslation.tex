...
\footnote{\url{https://docs.oracle.com/javase/8/docs/api/java/util/function/package-summary.html}}

I have included bytecode for one of the function calls as an example, only part of the constant pool is
included
