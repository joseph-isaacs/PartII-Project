...
\end{itemize}
  ...
  reasons, first it allows access to the fully features set
  of JVM tools as mentioned in the introduction and secondly
  the JVM itself provides garbage collection and 
  a more simple backend target (more simple than x86).
  This allows me to implement a whole compiler in the timescale given.
...
document in Appendix~\ref{appendix:bytecodetranslationdoc} about how I would implement code generation, 
