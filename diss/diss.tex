...
JVM compatible languages (through use of the monadic I/O system) and function inlining.

\section*{Work Completed}

All features highlighted were implemented (including all extensions).
...
\bigskip
\leftline{\textbf{Signed:} Joe Isaacs}
...
I would like to thank Robert Kovacsics, my project supervisor. His advice was invaluable.
